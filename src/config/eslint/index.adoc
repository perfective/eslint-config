...
| `link:{eslint-rules}/no-unassigned-vars[no-unassigned-vars]`
|
| Error
...
| `link:{eslint-rules}/preserve-caught-error[preserve-caught-error]`
|
| Off
3+| Requires ECMAScript 2022 and is not compatible with `@perfectice/common/error` `Exception` and functions.
