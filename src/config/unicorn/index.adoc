...
| `link:{eslint-unicorn-rules}/no-array-sort.md[unicorn/no-array-sort]`
| Yes
| Yes
| Off
...
| `link:{eslint-unicorn-rules}/no-immediate-mutation.md[unicorn/no-immediate-mutation]`
| Yes
| Yes
| Warning
...
| `link:{eslint-unicorn-rules}/no-useless-collection-argument.md[unicorn/no-useless-collection-argument]`
| Yes
| Yes
| Warning
...
| `link:{eslint-unicorn-rules}/prefer-bigint-literals.md[unicorn/prefer-bigint-literals]`
| Yes
| Yes
| Warning
...
| `link:{eslint-unicorn-rules}/prefer-classlist-toggle.md[unicorn/prefer-classlist-toggle]`
| Yes
| Yes
| Warning
...
| `link:{eslint-unicorn-rules}/prefer-response-static-json.md[unicorn/prefer-response-static-json]`
| Yes
| Yes
| Warning
...
| `link:{eslint-unicorn-rules}/require-module-attributes.md[unicorn/require-module-attributes]`
| Yes
| Yes
| Warning
