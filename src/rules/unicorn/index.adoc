...
| `link:https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-negated-condition.md[unicorn/no-negated-condition]`
| Yes
| Yes
| Warning
...
| `link:https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-typeof-undefined.md[unicorn/no-typeof-undefined]`
| Yes
| Yes
| Warning
...
| `link:https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/prefer-set-size.md[unicorn/prefer-set-size]`
| Yes
| Yes
| Warning
