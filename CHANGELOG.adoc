...
** `no-extra-parens` allows extra parens in nested binary expressions.
...
* Updated plugins:
** `eslint` to `7.20.0`;
** `@typescript-eslint` to `4.15.0`;
** `eslint-plugin-unicorn` to `28.0.0`;
** `eslint-plugin-jsdoc` to `31.6.1`;
