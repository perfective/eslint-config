...
+
* Upgraded `eslint-plugin-testing-library` to `5.0.4`:
** Renamed `testing-library/no-debug` into `testing-library/no-debugging-utils`.
+
* Upgraded `eslint-plugin-unicorn` to `40.1.0`:
...
* Updated `eslint-plugin-jsdoc` to `37.7.0.
